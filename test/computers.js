...
describe('Computers Services API', function() {
    it('GET '+base_url+'/api/v1/search/computers', function(done) {
    ...
    it('GET '+base_url+'/api/v1/search/computers?model=Asus&cpu=1', function(done) {
    ...
    it('GET '+base_url+'/api/v1/search/computers/1', function(done) {
